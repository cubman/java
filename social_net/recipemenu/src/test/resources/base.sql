...
//CREATE UNIQUE INDEX IF NOT EXISTS recipe_name_uindex ON recipe (name);
...
//CREATE UNIQUE INDEX IF NOT EXISTS ingredient_name_uindex ON ingredient (name);
...
//CREATE UNIQUE INDEX IF NOT EXISTS recipe_ingredient_uindex ON recipe_ingredient (recipe_id, ingredient_id);
